...
public class ShowTable extends AppCompatActivity implements Serializable {
    private String[] tables = new String[6];
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final UnionDeputyTable unionTable = (UnionDeputyTable)bundle0.getSerializable("UnionDepTable");
    ...
    private void printUDa(UnionDeputyTable unionTable){
        Intent intent = new Intent(ShowTable.this, ShowUniDep.class);

        Bundle bundle0 = new Bundle();
        bundle0.putSerializable("UnionDepTable",unionTable);
        intent.putExtras(bundle0);
        startActivity(intent);
    }
